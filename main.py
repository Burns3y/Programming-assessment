...
class GUI:
    ...
    def __init__(self, parent, player):
        ...
        for i in range(4):
            answer_option = Radiobutton(self.answer_frame, variable=self.answer, value=i, text=f"Option {i}", bg=PURPLE2, fg="white", selectcolor=PURPLE1, activebackground=PURPLE1, activeforeground="white")
    ...
    def display_question(self):
        ...
        question, self.options = self.player.get_random_question()
